...
import br.org.generation.projetohaqua.repository.PostagemRepository;
...
public class PostagemController {
	...
	@GetMapping
	public ResponseEntity<List<Postagem>> chamarTodasPostagens(){
	...
	public ResponseEntity<List<Postagem>> chamarPostagemTitulo(@PathVariable String titulo){
